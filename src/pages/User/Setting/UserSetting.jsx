...
const handleChangeUser = () => {
  ...
  return (
    <section className="text-white bg-[#121139] pb-40 sticky overflow-hidden ">
      ...
      <div className="items-center flex flex-col pt-[10rem]">
        <div className="container">
          <div className=" flex flex-col ">
            <div className="flex justify-start-start mt-20">
              ...
              <div className="">
                <form className="flex flex-col gap-y-2 ml-20 w-full">
                  <label
                    htmlFor="username"
                  ...
                  <input
                    type="text"
                    className="rounded-md py-1 pl-5 pr-[30rem] bg-[#25274C]"
            ...
            className="py-2 w-1/2 mx-auto rounded-md ml-20 bg-[#3239b4] mt-40"
          >
            Submit
          </button>
              </div>
