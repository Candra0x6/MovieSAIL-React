...
export default function Footer() {
  return (
    <div className="z-0 mx-auto flex bg-[#27294E] flex-col items-center sm:px-6 lg:px-8">
      <div className="flex flex-col z-[1] bg-[#27294E] -mt-20 w-[10rem] h-[10rem] items-center justify-end bg-[27294E] rounded-full">
        <img
          src={Img}
          className="h-full z-[1] w-full rounded-full p-3"
          alt="Profil Creator"
        />
      </div>
      <div className="flex flex-col text-base text-white mt-7 items-center justify-center">
        ...
        <p className="text-center mt-2 w-[80%]">
          ...
          JavaScript. It is powered by a range of cutting-edge Tailwind Css and
          React JS, ensuring a seamless and engaging user experience.
